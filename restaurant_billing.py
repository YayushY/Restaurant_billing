...
def Receipt():
    ...
    textReceipt.insert(END, 'Chicken Wings:\t\t\t\t\t' + kare_kare.get()+'\n')
    textReceipt.insert(END, 'Tandoori Chicken:\t\t\t\t\t' + crispy_pata.get()+'\n')
    textReceipt.insert(END, 'Crispy Chicken:\t\t\t\t\t' + sinigang_baboy.get()+'\n')
    textReceipt.insert(END, 'Chicken Rara:\t\t\t\t\t' + sinigang_hipon.get()+'\n')
    textReceipt.insert(END, 'Chicken popcorn:\t\t\t\t\t' + bicol_express.get()+'\n')
    textReceipt.insert(END, 'Paneer Tikka:\t\t\t\t\t' + asparagus_tofu.get()+'\n')
    textReceipt.insert(END, 'Fries:\t\t\t\t\t' + chicken_sisig.get()+'\n')
...
# Drinks
Cocktail = Checkbutton(Drinks_Function, text='Cold Coffee', variable=variable1, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
...
Sting = Checkbutton(Drinks_Function, text='Thumbs up', variable=variable7, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
                    bg='sky blue', command=drinksSting).grid(row=6, sticky=W)
Cobra = Checkbutton(Drinks_Function, text='Mojito', variable=variable8, onvalue=1, offvalue=0, font=('arial', 16, 'bold'),
...
KareKare = Checkbutton(Food_Function,text="Chicken Wings",variable=variable10,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsKareKare).grid(row=1,sticky=W)
CrispyPata = Checkbutton(Food_Function,text="Tandoori Chicken ",variable=variable11,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsCrispyPata).grid(row=2,sticky=W)
SinigangBaboy = Checkbutton(Food_Function,text="Crispy Chicken ",variable=variable12,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsSinigangBaboy).grid(row=3,sticky=W)
SinigangHipon = Checkbutton(Food_Function,text="Chicken Rara ",variable=variable13,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsSinigangHipon).grid(row=4,sticky=W)
BicolExpress = Checkbutton(Food_Function,text="Chicken popcorn ",variable=variable14,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsBicolExpress).grid(row=5,sticky=W)
AsparagusTofu = Checkbutton(Food_Function,text="Paneer tikka ",variable=variable15,onvalue = 1, offvalue=0,
                        font=('arial',16,'bold'),bg='sky blue',command=foodsAsparagusTofu).grid(row=6,sticky=W)
ChickenSisig = Checkbutton(Food_Function,text="Fries ",variable=variable16,onvalue = 1, offvalue=0,
